...
/** Bouton WhatsApp flottant premium, visible sur tout le site. */
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-[150] flex h-14 w-14 items-center justify-center rounded-full bg-[#1d1d1f] text-white shadow-[0_10px_30px_rgba(0,0,0,0.25)] transition-all duration-500 ease-[var(--ease-luxe)] hover:scale-105 hover:bg-gold md:bottom-8 md:right-8"
    >
      <span className="kg-wa-ping absolute inset-0 rounded-full" aria-hidden />
      <svg
        width="26"
        height="26"
        viewBox="0 0 24 24"
