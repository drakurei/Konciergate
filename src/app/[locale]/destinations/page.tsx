  ...
  return (
    <>
      ...
      <section className="bg-black">
        {/*
          Tuiles immersives prêtes à recevoir de grandes images :
          déposez vos visuels dans /public/images/destination-<pays>.jpg
          et remplacez le calque .hero-gradient par un <Image fill /> .
        */}
        {countries.map((c, i) => (
          <Reveal
            as="article"
          ...
          >
            <div className="hero-gradient absolute inset-0 transition-transform duration-[2s] ease-[var(--ease-luxe)] group-hover:scale-105" />
